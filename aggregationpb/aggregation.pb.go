...
type CombinedMetrics struct {
	...
	OverflowServiceInstancesEstimator []byte                 `protobuf:"bytes,3,opt,name=overflow_service_instances_estimator,json=overflowServiceInstancesEstimator,proto3" json:"overflow_service_instances_estimator,omitempty"`
...
func (x *CombinedMetrics) GetOverflowServiceInstancesEstimator() []byte {
	if x != nil {
		return x.OverflowServiceInstancesEstimator
	}
	return nil
}
...
type ServiceMetrics struct {
	...
	ServiceInstanceMetrics []*KeyedServiceInstanceMetrics `protobuf:"bytes,1,rep,name=service_instance_metrics,json=serviceInstanceMetrics,proto3" json:"service_instance_metrics,omitempty"`
	OverflowGroups         *Overflow                      `protobuf:"bytes,2,opt,name=overflow_groups,json=overflowGroups,proto3" json:"overflow_groups,omitempty"`
}
...
func (x *ServiceMetrics) GetServiceInstanceMetrics() []*KeyedServiceInstanceMetrics {
	if x != nil {
...
type ServiceInstanceAggregationKey struct {
	...
	GlobalLabelsStr []byte `protobuf:"bytes,1,opt,name=global_labels_str,json=globalLabelsStr,proto3" json:"global_labels_str,omitempty"`
}

func (x *ServiceInstanceAggregationKey) Reset() {
	*x = ServiceInstanceAggregationKey{}
	if protoimpl.UnsafeEnabled {
...
func (x *ServiceInstanceAggregationKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ServiceInstanceAggregationKey) ProtoMessage() {}

func (x *ServiceInstanceAggregationKey) ProtoReflect() protoreflect.Message {
	mi := &file_proto_aggregation_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ServiceInstanceAggregationKey.ProtoReflect.Descriptor instead.
func (*ServiceInstanceAggregationKey) Descriptor() ([]byte, []int) {
	return file_proto_aggregation_proto_rawDescGZIP(), []int{4}
}

func (x *ServiceInstanceAggregationKey) GetGlobalLabelsStr() []byte {
	if x != nil {
		return x.GlobalLabelsStr
	}
	return nil
...
type ServiceInstanceMetrics struct {
	...
	TransactionMetrics                []*KeyedTransactionMetrics                `protobuf:"bytes,1,rep,name=transaction_metrics,json=transactionMetrics,proto3" json:"transaction_metrics,omitempty"`
	ServiceTransactionMetrics         []*KeyedServiceTransactionMetrics         `protobuf:"bytes,2,rep,name=service_transaction_metrics,json=serviceTransactionMetrics,proto3" json:"service_transaction_metrics,omitempty"`
	SpanMetrics                       []*KeyedSpanMetrics                       `protobuf:"bytes,3,rep,name=span_metrics,json=spanMetrics,proto3" json:"span_metrics,omitempty"`
	ServiceInstanceTransactionMetrics []*KeyedServiceInstanceTransactionMetrics `protobuf:"bytes,4,rep,name=service_instance_transaction_metrics,json=serviceInstanceTransactionMetrics,proto3" json:"service_instance_transaction_metrics,omitempty"`
}
...
func (x *ServiceInstanceMetrics) GetTransactionMetrics() []*KeyedTransactionMetrics {
	if x != nil {
...
func (x *ServiceInstanceMetrics) GetServiceTransactionMetrics() []*KeyedServiceTransactionMetrics {
	if x != nil {
...
func (x *ServiceInstanceMetrics) GetSpanMetrics() []*KeyedSpanMetrics {
	if x != nil {
...
func (x *ServiceInstanceMetrics) GetServiceInstanceTransactionMetrics() []*KeyedServiceInstanceTransactionMetrics {
	if x != nil {
...
type KeyedServiceInstanceMetrics struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Key     *ServiceInstanceAggregationKey `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Metrics *ServiceInstanceMetrics        `protobuf:"bytes,2,opt,name=metrics,proto3" json:"metrics,omitempty"`
}

func (x *KeyedServiceInstanceMetrics) Reset() {
	*x = KeyedServiceInstanceMetrics{}
	if protoimpl.UnsafeEnabled {
...
func (x *KeyedServiceInstanceMetrics) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*KeyedServiceInstanceMetrics) ProtoMessage() {}

func (x *KeyedServiceInstanceMetrics) ProtoReflect() protoreflect.Message {
	mi := &file_proto_aggregation_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use KeyedServiceInstanceMetrics.ProtoReflect.Descriptor instead.
func (*KeyedServiceInstanceMetrics) Descriptor() ([]byte, []int) {
	return file_proto_aggregation_proto_rawDescGZIP(), []int{6}
}

func (x *KeyedServiceInstanceMetrics) GetKey() *ServiceInstanceAggregationKey {
	if x != nil {
		return x.Key
	}
	return nil
...
func (x *KeyedServiceInstanceMetrics) GetMetrics() *ServiceInstanceMetrics {
	if x != nil {
		return x.Metrics
	}
	return nil
...
func (x *CountValue) Reset() {
	*x = CountValue{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_aggregation_proto_msgTypes[19]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CountValue) Descriptor() ([]byte, []int) {
	return file_proto_aggregation_proto_rawDescGZIP(), []int{19}
}

func (x *CountValue) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *CountValue) GetValue() int64 {
	if x != nil {
		return x.Value
	}
	return 0
...
func (x *HDRHistogram) Reset() {
	*x = HDRHistogram{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_aggregation_proto_msgTypes[20]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*HDRHistogram) Descriptor() ([]byte, []int) {
	return file_proto_aggregation_proto_rawDescGZIP(), []int{20}
}
...
type Overflow struct {
	...
	OverflowServiceInstanceTransactions          *ServiceInstanceTransactionMetrics `protobuf:"bytes,2,opt,name=overflow_service_instance_transactions,json=overflowServiceInstanceTransactions,proto3" json:"overflow_service_instance_transactions,omitempty"`
	OverflowServiceTransactions                  *ServiceTransactionMetrics         `protobuf:"bytes,3,opt,name=overflow_service_transactions,json=overflowServiceTransactions,proto3" json:"overflow_service_transactions,omitempty"`
	OverflowSpans                                *SpanMetrics                       `protobuf:"bytes,4,opt,name=overflow_spans,json=overflowSpans,proto3" json:"overflow_spans,omitempty"`
	OverflowTransactionsEstimator                []byte                             `protobuf:"bytes,5,opt,name=overflow_transactions_estimator,json=overflowTransactionsEstimator,proto3" json:"overflow_transactions_estimator,omitempty"`
	OverflowServiceInstanceTransactionsEstimator []byte                             `protobuf:"bytes,6,opt,name=overflow_service_instance_transactions_estimator,json=overflowServiceInstanceTransactionsEstimator,proto3" json:"overflow_service_instance_transactions_estimator,omitempty"`
	OverflowServiceTransactionsEstimator         []byte                             `protobuf:"bytes,7,opt,name=overflow_service_transactions_estimator,json=overflowServiceTransactionsEstimator,proto3" json:"overflow_service_transactions_estimator,omitempty"`
	OverflowSpansEstimator                       []byte                             `protobuf:"bytes,8,opt,name=overflow_spans_estimator,json=overflowSpansEstimator,proto3" json:"overflow_spans_estimator,omitempty"`
}

func (x *Overflow) Reset() {
	*x = Overflow{}
	if protoimpl.UnsafeEnabled {
		mi := &file_proto_aggregation_proto_msgTypes[21]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Overflow) Descriptor() ([]byte, []int) {
	return file_proto_aggregation_proto_rawDescGZIP(), []int{21}
}
...
var file_proto_aggregation_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x2e, 0x61, 0x70, 0x6d, 0x22, 0xce, 0x02, 0x0a, 0x0f, 0x43, 0x6f, 0x6d, 0x62, 0x69,
	...
	,
	...
	,
	...
	,
	...
	0x01, 0x28, 0x08, 0x52, 0x09, 0x74, 0x72, 0x61, 0x63, 0x65, 0x52, 0x6f, 0x6f, 0x74, 0x12, 0x27,
	...
	,
	...
	,
	...
	,
	...
	0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6c, 0x6f, 0x75, 0x64, 0x5f, 0x72,
	0x65, 0x67, 0x69, 0x6f, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x63, 0x6c, 0x6f,
	0x75, 0x64, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x12, 0x36, 0x0a, 0x17, 0x63, 0x6c, 0x6f, 0x75,
	0x64, 0x5f, 0x61, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x5f, 0x7a,
	0x6f, 0x6e, 0x65, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x15, 0x63, 0x6c, 0x6f, 0x75, 0x64,
	...
	,
	...
	,
	...
	,
	...
	0x54, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x4d, 0x65, 0x74, 0x72, 0x69,
	0x63, 0x73, 0x52, 0x14, 0x6f, 0x76, 0x65, 0x72, 0x66, 0x6c, 0x6f, 0x77, 0x54, 0x72, 0x61, 0x6e,
	0x73, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x83, 0x01, 0x0a, 0x26, 0x6f, 0x76, 0x65,
	0x72, 0x66, 0x6c, 0x6f, 0x77, 0x5f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x5f, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x5f, 0x74, 0x72, 0x61, 0x6e, 0x73, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2e, 0x2e, 0x65, 0x6c, 0x61, 0x73,
	...
	,
...
var file_proto_aggregation_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_proto_aggregation_proto_goTypes = []interface{}{
	...
	(*ServiceInstanceAggregationKey)(nil),            // 4: elastic.apm.ServiceInstanceAggregationKey
	(*ServiceInstanceMetrics)(nil),                   // 5: elastic.apm.ServiceInstanceMetrics
	(*KeyedServiceInstanceMetrics)(nil),              // 6: elastic.apm.KeyedServiceInstanceMetrics
	(*KeyedTransactionMetrics)(nil),                  // 7: elastic.apm.KeyedTransactionMetrics
	(*TransactionAggregationKey)(nil),                // 8: elastic.apm.TransactionAggregationKey
	(*TransactionMetrics)(nil),                       // 9: elastic.apm.TransactionMetrics
	(*KeyedServiceInstanceTransactionMetrics)(nil),   // 10: elastic.apm.KeyedServiceInstanceTransactionMetrics
	(*ServiceInstanceTransactionAggregationKey)(nil), // 11: elastic.apm.ServiceInstanceTransactionAggregationKey
	(*ServiceInstanceTransactionMetrics)(nil),        // 12: elastic.apm.ServiceInstanceTransactionMetrics
	(*KeyedServiceTransactionMetrics)(nil),           // 13: elastic.apm.KeyedServiceTransactionMetrics
	(*ServiceTransactionAggregationKey)(nil),         // 14: elastic.apm.ServiceTransactionAggregationKey
	(*ServiceTransactionMetrics)(nil),                // 15: elastic.apm.ServiceTransactionMetrics
	(*KeyedSpanMetrics)(nil),                         // 16: elastic.apm.KeyedSpanMetrics
	(*SpanAggregationKey)(nil),                       // 17: elastic.apm.SpanAggregationKey
	(*SpanMetrics)(nil),                              // 18: elastic.apm.SpanMetrics
	(*CountValue)(nil),                               // 19: elastic.apm.CountValue
	(*HDRHistogram)(nil),                             // 20: elastic.apm.HDRHistogram
	(*Overflow)(nil),                                 // 21: elastic.apm.Overflow
}
var file_proto_aggregation_proto_depIdxs = []int32{
	...
	21, // 1: elastic.apm.CombinedMetrics.overflow_services:type_name -> elastic.apm.Overflow
	...
	6,  // 4: elastic.apm.ServiceMetrics.service_instance_metrics:type_name -> elastic.apm.KeyedServiceInstanceMetrics
	21, // 5: elastic.apm.ServiceMetrics.overflow_groups:type_name -> elastic.apm.Overflow
	7,  // 6: elastic.apm.ServiceInstanceMetrics.transaction_metrics:type_name -> elastic.apm.KeyedTransactionMetrics
	13, // 7: elastic.apm.ServiceInstanceMetrics.service_transaction_metrics:type_name -> elastic.apm.KeyedServiceTransactionMetrics
	16, // 8: elastic.apm.ServiceInstanceMetrics.span_metrics:type_name -> elastic.apm.KeyedSpanMetrics
	10, // 9: elastic.apm.ServiceInstanceMetrics.service_instance_transaction_metrics:type_name -> elastic.apm.KeyedServiceInstanceTransactionMetrics
	4,  // 10: elastic.apm.KeyedServiceInstanceMetrics.key:type_name -> elastic.apm.ServiceInstanceAggregationKey
	5,  // 11: elastic.apm.KeyedServiceInstanceMetrics.metrics:type_name -> elastic.apm.ServiceInstanceMetrics
	8,  // 12: elastic.apm.KeyedTransactionMetrics.key:type_name -> elastic.apm.TransactionAggregationKey
	9,  // 13: elastic.apm.KeyedTransactionMetrics.metrics:type_name -> elastic.apm.TransactionMetrics
	20, // 14: elastic.apm.TransactionMetrics.histogram:type_name -> elastic.apm.HDRHistogram
	11, // 15: elastic.apm.KeyedServiceInstanceTransactionMetrics.key:type_name -> elastic.apm.ServiceInstanceTransactionAggregationKey
	12, // 16: elastic.apm.KeyedServiceInstanceTransactionMetrics.metrics:type_name -> elastic.apm.ServiceInstanceTransactionMetrics
	20, // 17: elastic.apm.ServiceInstanceTransactionMetrics.histogram:type_name -> elastic.apm.HDRHistogram
	14, // 18: elastic.apm.KeyedServiceTransactionMetrics.key:type_name -> elastic.apm.ServiceTransactionAggregationKey
	15, // 19: elastic.apm.KeyedServiceTransactionMetrics.metrics:type_name -> elastic.apm.ServiceTransactionMetrics
	20, // 20: elastic.apm.ServiceTransactionMetrics.histogram:type_name -> elastic.apm.HDRHistogram
	17, // 21: elastic.apm.KeyedSpanMetrics.key:type_name -> elastic.apm.SpanAggregationKey
	18, // 22: elastic.apm.KeyedSpanMetrics.metrics:type_name -> elastic.apm.SpanMetrics
	9,  // 23: elastic.apm.Overflow.overflow_transactions:type_name -> elastic.apm.TransactionMetrics
	12, // 24: elastic.apm.Overflow.overflow_service_instance_transactions:type_name -> elastic.apm.ServiceInstanceTransactionMetrics
	15, // 25: elastic.apm.Overflow.overflow_service_transactions:type_name -> elastic.apm.ServiceTransactionMetrics
	18, // 26: elastic.apm.Overflow.overflow_spans:type_name -> elastic.apm.SpanMetrics
...
func file_proto_aggregation_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_aggregation_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ServiceInstanceAggregationKey); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_aggregation_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*KeyedServiceInstanceMetrics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_aggregation_proto_msgTypes[19].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_aggregation_proto_msgTypes[20].Exporter = func(v interface{}, i int) interface{} {
		...
		file_proto_aggregation_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
