...
func (m *CombinedMetrics) CloneVT() *CombinedMetrics {
	...
	r := new(CombinedMetrics)
	r.OverflowServices = m.OverflowServices.CloneVT()
	r.EventsTotal = m.EventsTotal
	r.YoungestEventTimestamp = m.YoungestEventTimestamp
...
func (m *ServiceAggregationKey) CloneVT() *ServiceAggregationKey {
	...
	r := new(ServiceAggregationKey)
	r.Timestamp = m.Timestamp
	r.ServiceName = m.ServiceName
	r.ServiceEnvironment = m.ServiceEnvironment
	r.ServiceLanguageName = m.ServiceLanguageName
...
func (m *KeyedServiceTransactionMetrics) CloneVT() *KeyedServiceTransactionMetrics {
	...
	r := new(KeyedServiceTransactionMetrics)
	r.Key = m.Key.CloneVT()
	r.Metrics = m.Metrics.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *ServiceTransactionAggregationKey) CloneVT() *ServiceTransactionAggregationKey {
	...
	r := new(ServiceTransactionAggregationKey)
	r.TransactionType = m.TransactionType
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *ServiceTransactionMetrics) CloneVT() *ServiceTransactionMetrics {
	...
	r := new(ServiceTransactionMetrics)
	r.Histogram = m.Histogram.CloneVT()
	r.FailureCount = m.FailureCount
	r.SuccessCount = m.SuccessCount
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
	}
...
func (m *SpanAggregationKey) CloneVT() *SpanAggregationKey {
	...
	r := new(SpanAggregationKey)
	r.SpanName = m.SpanName
	r.Outcome = m.Outcome
...
func (m *Overflow) CloneVT() *Overflow {
	...
	r := new(Overflow)
	r.OverflowTransactions = m.OverflowTransactions.CloneVT()
	r.OverflowServiceTransactions = m.OverflowServiceTransactions.CloneVT()
	r.OverflowSpans = m.OverflowSpans.CloneVT()
...
func (m *HDRHistogram) CloneVT() *HDRHistogram {
	...
	r := new(HDRHistogram)
	r.LowestTrackableValue = m.LowestTrackableValue
	r.HighestTrackableValue = m.HighestTrackableValue
	r.SignificantFigures = m.SignificantFigures
...
func (m *CombinedMetrics) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.YoungestEventTimestamp != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.YoungestEventTimestamp))
		i--
		dAtA[i] = 0x28
	}
	if m.EventsTotal != 0 {
	...
	if len(m.OverflowServicesEstimator) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.OverflowServicesEstimator)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *TransactionAggregationKey) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.CloudProjectName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudProjectName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xea
	...
	if len(m.CloudProjectId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudProjectId)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xe2
	...
	if len(m.CloudMachineType) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudMachineType)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xda
	...
	if len(m.CloudAccountName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudAccountName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xd2
	...
	if len(m.CloudAccountId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudAccountId)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xca
	...
	if len(m.CloudServiceName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudServiceName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xc2
	...
	if len(m.CloudAvailabilityZone) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudAvailabilityZone)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xba
	...
	if len(m.CloudRegion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.CloudRegion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xb2
	...
	if len(m.FaasTriggerType) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FaasTriggerType)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0xa2
	...
	if len(m.FaasVersion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FaasVersion)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x9a
	...
	if len(m.FaasName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FaasName)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x92
	...
	if len(m.FaasId) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FaasId)))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x8a
	...
	if m.FaasColdstart != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.FaasColdstart))
		i--
		dAtA[i] = 0x1
		i--
		dAtA[i] = 0x80
	...
	if len(m.TransactionResult) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TransactionResult)))
		i--
		dAtA[i] = 0x7a
	}
	if len(m.TransactionType) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TransactionType)))
		i--
		dAtA[i] = 0x72
	}
	if len(m.TransactionName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TransactionName)))
		i--
		dAtA[i] = 0x6a
	}
	if len(m.EventOutcome) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.EventOutcome)))
		i--
		dAtA[i] = 0x62
	}
	if len(m.HostOsPlatform) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.HostOsPlatform)))
		i--
		dAtA[i] = 0x5a
	}
	if len(m.HostName) > 0 {
	...
	if len(m.HostHostname) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.HostHostname)))
		i--
		dAtA[i] = 0x4a
	}
	if len(m.ServiceLanguageVersion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceLanguageVersion)))
		i--
		dAtA[i] = 0x42
	}
	if len(m.ServiceRuntimeVersion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceRuntimeVersion)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.ServiceRuntimeName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceRuntimeName)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.ServiceNodeName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceNodeName)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ServiceVersion) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.ServiceVersion)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.KubernetesPodName) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.KubernetesPodName)))
		i--
		dAtA[i] = 0x1a
	}
...
func (m *TransactionAggregationKey) SizeVT() (n int) {
	...
	if m.FaasColdstart != 0 {
		n += 2 + protohelpers.SizeOfVarint(uint64(m.FaasColdstart))
	}
	l = len(m.FaasId)
	if l > 0 {
...
func (m *KeyedTransactionMetrics) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Key == nil {
				m.Key = &TransactionAggregationKey{}
			}
			if err := m.Key.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *KeyedServiceTransactionMetrics) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Key == nil {
				m.Key = &ServiceTransactionAggregationKey{}
			}
			if err := m.Key.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
		...
		case 2:
			...
			if m.Metrics == nil {
				m.Metrics = &ServiceTransactionMetrics{}
			}
			if err := m.Metrics.UnmarshalVT(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
...
func (m *Overflow) UnmarshalVT(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.OverflowTransactions == nil {
				m.OverflowTransactions = &TransactionMetrics{}
			}
		...
		case 2:
			...
			if m.OverflowServiceTransactions == nil {
				m.OverflowServiceTransactions = &ServiceTransactionMetrics{}
			}
