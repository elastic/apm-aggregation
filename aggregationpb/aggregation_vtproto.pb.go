...
// protoc-gen-go-vtproto version: v0.4.1-0.20230829082524-cb44ee83ff7f
...
func (m *ServiceMetrics) ResetVT() {
	...
	f2 := m.SpanMetrics[:0]
	for _, mm := range m.ServiceInstanceTransactionMetrics {
		mm.ResetVT()
	}
